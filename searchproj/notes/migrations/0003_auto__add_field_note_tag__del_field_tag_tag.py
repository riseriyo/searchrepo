...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'notes_tag', 'tag',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 10, 9, 0, 0), max_length=250, unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'notes.tag': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'tagnames': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'null': 'True', 'symmetrical': 'False', 'to': u"orm['notes.Note']"})
        },
        u'profiles.position': {
